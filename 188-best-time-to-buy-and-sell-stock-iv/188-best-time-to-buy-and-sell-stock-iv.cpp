...
//         if(buy){
//             int buy = -prices[i] + solve(prices,i+1,k,!buy,dp) ;
//             int notBuy = solve(prices,i+1,k,buy,dp);
//             res = max(buy,notBuy);
//         }
//         else{
//             int sell = prices[i] + solve(prices,i+1,k-1,!buy,dp);
//             int notSell = solve(prices, i+1, k, buy,dp);
